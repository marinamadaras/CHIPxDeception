...
class EmpatheticStrategy(FramingStrategy):
    ...
    def generate_advice(self, context: dict, user_input: dict) -> str:
        ...
        prompt_activity = f"""The user talking to you is a diabetes patient.\n
                            ### Context ###\n
                            The context is: you have found that the activity {hardcoded_activity} is a suitable one for the patient.\n
                            ### Task ###\n
                            Formulate a suggestion with the given activity for the diabetes patient."""
